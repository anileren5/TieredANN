...
int build_incremental_index(const std::string &data_path, const unsigned L,
  ...
  greator::Index<T, TagT> index(greator::L2, dim, num_points, true,
...
#pragma omp parallel for
  ...
  greator::cout << "Deleting " << delete_list.size() << " elements"
                << std::endl;
  ...
  greator::cout << "Size of delete_vector : " << delete_vector.size()
                << std::endl;
  {
    index.enable_delete();
