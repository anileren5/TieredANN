...
QUERY_PATH="data/$DATASET/noisy_queries_groundtruths/${DATASET}_query.noisy_nrounds-5_noiseratio-0.1.bin" # Concatenated base+noisy queries
GROUNDTRUTH_PATH="./data/$DATASET/noisy_queries_groundtruths/${DATASET}_groundtruth.noisy_nrounds-5_noiseratio-0.1.bin" # Concatenated base+noisy groundtruth
R=64
MEMORY_L=128
DISK_L=128
K=100
...
./build/tests/qvcache_split_search_noisy \
  --data_type "$DATA_TYPE" \
  --data_path "$DATA_PATH" \
