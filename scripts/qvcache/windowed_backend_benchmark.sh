...
# Script to run windowed backend-only benchmark experiment with noisy queries
# This script uses the noisy queries generated by generate_noisy_queries.py
# and runs the windowed_backend_benchmark experiment (without QVCache)
...
echo "=========================================="
echo "Windowed Backend Benchmark - Noisy Queries"
echo "=========================================="
...
./build/tests/windowed_backend_benchmark \
  --data_type "$DATA_TYPE" \
  --data_path "$DATA_PATH" \
