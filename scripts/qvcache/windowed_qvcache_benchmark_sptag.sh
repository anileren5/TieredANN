...
# Script to run windowed QVCache benchmark experiment with noisy queries using SPTAG backend
# This script uses the noisy queries generated by generate_noisy_queries.py
# and runs the windowed_qvcache_benchmark_sptag experiment with window-based processing
...
echo "=========================================="
echo "Windowed QVCache Benchmark (SPTAG) - Noisy Queries"
echo "=========================================="
...
./build/tests/windowed_qvcache_benchmark_sptag \
  --data_type "$DATA_TYPE" \
  --data_path "$DATA_PATH" \
