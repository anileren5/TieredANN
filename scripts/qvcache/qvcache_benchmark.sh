...
# Script to run QVCache benchmark experiment with noisy queries
# This script uses the noisy queries generated by generate_noisy_queries.py
# and runs the qvcache_benchmark experiment with window-based processing
...
echo "=========================================="
echo "QVCache Benchmark - Noisy Queries"
echo "=========================================="
