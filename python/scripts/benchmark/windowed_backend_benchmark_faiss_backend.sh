...
# Script to run windowed backend-only benchmark experiment with noisy queries using FAISS backend
# This script uses the noisy queries generated by generate_noisy_queries.py
# and runs the windowed_backend_benchmark_faiss_backend.py experiment (without QVCache)
...
echo "=========================================="
echo "Windowed Backend Benchmark (FAISS) - Noisy Queries"
echo "=========================================="
...
python3 python/benchmarks/windowed_backend_benchmark_faiss_backend.py \
  --data_path "$DATA_PATH" \
