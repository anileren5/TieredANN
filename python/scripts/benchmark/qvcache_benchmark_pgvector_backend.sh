...
# Script to run QVCache benchmark experiment with noisy queries using pgvector backend
# This script uses the noisy queries generated by generate_noisy_queries.py
# and runs the qvcache_benchmark_pgvector_backend experiment with window-based processing
...
echo "=========================================="
echo "QVCache Benchmark - Noisy Queries (pgvector)"
echo "=========================================="
...
python3 python/benchmarks/qvcache_benchmark_pgvector_backend.py \
  --data_type "$DATA_TYPE" \
  --data_path "$DATA_PATH" \
