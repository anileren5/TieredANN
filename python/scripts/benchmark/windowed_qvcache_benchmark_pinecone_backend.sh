...
# Script to run windowed QVCache benchmark experiment with noisy queries using Pinecone backend
# This script uses the noisy queries generated by generate_noisy_queries.py
# and runs the windowed_qvcache_benchmark_pinecone_backend.py experiment with window-based processing
...
echo "=========================================="
echo "Windowed QVCache Benchmark (Pinecone) - Noisy Queries"
echo "=========================================="
...
CMD="python3 python/benchmarks/windowed_qvcache_benchmark_pinecone_backend.py \
  --data_path \"$DATA_PATH\" \
