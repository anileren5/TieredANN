...
# Script to run QVCache benchmark experiment with noisy queries using FAISS backend
# This script uses the noisy queries generated by generate_noisy_queries.py
# and runs the qvcache_benchmark_faiss_backend experiment with window-based processing
...
echo "=========================================="
echo "QVCache Benchmark - Noisy Queries (FAISS)"
echo "=========================================="
...
python3 python/benchmarks/qvcache_benchmark_faiss_backend.py \
  --data_type "$DATA_TYPE" \
  --data_path "$DATA_PATH" \
