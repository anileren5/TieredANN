...
# Script to run windowed QVCache benchmark experiment with noisy queries using PgVector backend
# This script uses the noisy queries generated by generate_noisy_queries.py
# and runs the windowed_qvcache_benchmark_pgvector_backend.py experiment with window-based processing
...
echo "=========================================="
echo "Windowed QVCache Benchmark (PgVector) - Noisy Queries"
echo "=========================================="
...
python3 python/benchmarks/windowed_qvcache_benchmark_pgvector_backend.py \
  --data_path "$DATA_PATH" \
