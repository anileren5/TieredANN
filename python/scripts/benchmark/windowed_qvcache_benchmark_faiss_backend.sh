...
# Script to run windowed QVCache benchmark experiment with noisy queries using FAISS backend
# This script uses the noisy queries generated by generate_noisy_queries.py
# and runs the windowed_qvcache_benchmark_faiss_backend.py experiment with window-based processing
...
echo "=========================================="
echo "Windowed QVCache Benchmark (FAISS) - Noisy Queries"
echo "=========================================="
...
python3 python/benchmarks/windowed_qvcache_benchmark_faiss_backend.py \
  --data_path "$DATA_PATH" \
