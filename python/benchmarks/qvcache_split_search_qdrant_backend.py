#!/usr/bin/env python3
"""
Python version of qvcache_split_search_bruteforce_backend.py using Qdrant backend

This script allows running the same test as the C++ version but using
a Python-implemented Qdrant backend.
"""
...
def experiment_split(
    ...
    """Run the split search experiment with Qdrant backend."""
...
def main():
    parser = argparse.ArgumentParser(description="QVCache split search experiment with Qdrant backend")
