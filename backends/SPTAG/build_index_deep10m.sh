#!/bin/bash
# Script to build SPTAG index for deep10m dataset
...
# Build parameters
# Use single thread to avoid segmentation fault (SPTAG has memory corruption issues with multi-threaded builds)
NUM_THREADS=1
...
echo "Building index (this may take a while for 10M vectors)..."
